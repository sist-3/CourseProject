...
public class AddStudentDialog extends JDialog {
	...
	private void init() {
		...
		contentPanel.setLayout(null);
		{
			...
			birth_Y.setBounds(101, 153, 71, 23);
			panel.add(birth_Y);
			...
			birth_M.setBounds(215, 153, 71, 23);
			panel.add(birth_M);
